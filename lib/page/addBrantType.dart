...
class AddBrandType extends StatefulWidget {
  @override
  _AddBrandTypeState createState() => _AddBrandTypeState();
}

class _AddBrandTypeState extends State<AddBrandType> {
    ...
    return Padding(
      ...
      child: Container(
        child: TextField(
          controller: txt_desc,
          decoration: InputDecoration(
            labelText: 'ປ້ອນລາຍລະອຽດປະເພດສີນຄ້າ',
            enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(25.0),
              borderSide: BorderSide(
                color: Colors.blue,
